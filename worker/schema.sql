...
CREATE TABLE IF NOT EXISTS events (id INTEGER PRIMARY KEY AUTOINCREMENT,route_id INTEGER,event_date TEXT NOT NULL,event_time TEXT NOT NULL,price INTEGER NOT NULL,max_places INTEGER DEFAULT 30,free_places INTEGER DEFAULT 30,meeting_point TEXT,status TEXT DEFAULT 'active',template_id INTEGER,image_key TEXT,FOREIGN KEY(route_id) REFERENCES routes(id),FOREIGN KEY(template_id) REFERENCES event_templates(id));
